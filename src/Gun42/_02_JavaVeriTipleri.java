...
public class _02_JavaVeriTipleri {
    public static void main(String[] args) {
        ...
        // ilkel tip, privite tip: short,byte,long,double,boolean
        int sayi1=5;
        int sayi2=12;

        sayi1=sayi2; // sayi1=12, sayi2 nin değeri alındı ve sayi1 e eşitlendi.
        sayi1=34;
        sayi2=45;
        System.out.println("sayi1 = " + sayi1);
        System.out.println("sayi2 = " + sayi2);

        //Referans tipler: class, diziler,Arraylar, nesneler
        ...
        System.out.println("dizi2 = " +Arrays.toString(dizi1));//5,6
        System.out.println("dizi2 = " +Arrays.toString(dizi2));// 5,6
        ...
        String ad1="mehmet";
        String ad2="ismet";
        ad1=ad2; //ismet değeri verildi koğpyalandı.

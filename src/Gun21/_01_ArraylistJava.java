...
public class _01_ArraylistJava {
    public static void main(String[ ] args) {
        ...
        isimler.add(1,"Nurhayat");// verilen index e ekliyor,diğerleri 1 kayıyor
        System.out.println("isimler = " + isimler);
        System.out.println("isimler.size() = " + isimler.size());
        isimler.set(1,"Elife"); // verilen indexteki elemanı değiştirir.
        System.out.println("isimler = " + isimler);
        boolean varMi=isimler.contains("Elife");// eLİFE VAR MI
        System.out.println("varMi = " + varMi);
        isimler.remove("Ahmet" ); // değere göre sil
        System.out.println("varMi = " + varMi);
        isimler.remove(2);// Burak indekse göre sil
        System.out.println("varMi = " + varMi);

...
public class _02_Java2DArrayList {
    public static void main(String[] args) {
        ...
        int [][] tablo=new int[20][10];// 20 satir 10 sutunu var.200 sayı saklar
        ...
        System.out.println("tumNotlar.get(1) = " + tumNotlar.get(1)); // fizNotlari
        System.out.println("tumNotlar.get(2) = " + tumNotlar.get(2)); // kimNotlari
